...
void RealizarPedido(char productos[][30],float cantidadesPorProducto[][10],char ingredientes[][30],float stock[10],float tiemposProduccion[5],int numProductos,int numIngredientes);